     ...
     <div className="grid grid-cols-2 gap-6">
      ...
      <div className="flex gap-6">
          ...
          <label htmlFor="weekDays">Selecione os dias para pagamento</label>
            <ToggleGroup.Root type="multiple" className="grid grid-cols-4 gap-2" onValueChange={}>
              ...
              < ToggleGroup.Item value="6" title="Sabado" className="w-8 h-8 rounded bg-zinc-900">S</ ToggleGroup.Item>
            </ToggleGroup.Root>
          </div>
